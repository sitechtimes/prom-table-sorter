  ...
  <div id="app">
    <div class="Ldiv">
      <div v-if="showExample2" class="ex example2">
        ...
        <img @click="showExample2 = !showExample2" class="closeIcon" src="/public/close.png" alt="x to close webpage" />
      </div>
      <div v-if="showExample1" class="ex example1">
        <img src="/public/rows-columns-info.png"
          alt="Example image of several names in one cell separated by a comma for reference" />
        <img @click="showExample1 = !showExample1" class="closeIcon" src="/public/close.png" alt="x to close webpage" />
      </div>
      <h1>Prom Sorter</h1>
      <ul>
      ...
      <div class="form">
        ...
        <label class="dataFormatContainer" for="input-groups"></label>

        <label for="data-format">
          <h3>2. Select data file format:</h3>
        </label>
        <div class="dataFormatContainer">
          <input class="checkbox" v-model="dataFormat" type="checkbox" id="rows-columns" value="rows-columns" checked />
        ...
        <label class="dataFormatContainer" for=""></label>
        <label for="cell-range">
          <h3>3. Select data file format:</h3>
        </label>
